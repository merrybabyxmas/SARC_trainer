...
*** 수정 
    1. 실행 명령어 : ((.venv) ) yein40@mllab40-System-Product-Name:~$ python -m mindcastlib.pipeline.analysis_pipeline
    2. 예시 output : /home/yein40/outputs/ex/infer_20251116_132600.json